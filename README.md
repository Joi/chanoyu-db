...
- **Version:** 1.7.0 (see [CHANGELOG.md](CHANGELOG.md) for details)
...
This software powers the public site for Ito Chanoyu: `https://chanoyu.ito.com/` (Ito Chanoyu DB). Version 1.7.0 features professional test infrastructure with vitest, comprehensive testing utilities, and strategic test coverage for critical paths.
...
**v1.7.0 (October 2025)** - Professional Test Infrastructure
- Comprehensive vitest configuration with jsdom environment
- Test helpers and fixtures for consistent testing patterns
- Strategic test coverage (40 tests passing) focusing on critical paths
- See [tests/README.md](tests/README.md) for patterns and examples

**v1.6.0 (October 2025)** - Enhanced Admin UX
- FormCard and BilingualLabel components for structured editing
- Card-based object edit layout with logical sections
- Navbar auto-close improvements and accessibility enhancements

**v1.5.0 (October 2025)** - Tea Ceremony Design System
- Design system aligned with tea ceremony aesthetics (shibui, wabi, yugen, matcha)
- Ma-based spacing philosophy (間 - negative space)
- Bilingual typography with structural support
- Amplifier tools for AI-powered development
